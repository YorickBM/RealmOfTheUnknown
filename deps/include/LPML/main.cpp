...
#pragma endregion
	...
	LowPolyMeshLibrary::shader shader("shader.vertshader", "shader.fragshader");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		camera.Update(shader, projection, camera.GetViewMatrix()); //Do projection calculation also inside Camera class?!
