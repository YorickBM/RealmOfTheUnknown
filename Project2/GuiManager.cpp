...
CEGUI::OpenGL3Renderer* GuiManager::m_renderer = nullptr;
...
CEGUI::Window* GuiManager::createWidget(const std::string& type, const glm::vec4& destRectPerc, const glm::vec4& destRectPix, const std::string& name /*= ""*/) {
...
void GuiManager::setWidgetDestRect(CEGUI::Window* widget, const glm::vec4& destRectPerc, const glm::vec4& destRectPix) {
