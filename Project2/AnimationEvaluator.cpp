...
Pose AnimationEvaluator::Evaluate(Animation & animation, double time)
{
	...
	animation.ForEachChannel([&](AnimChannel& channel) {
		...
		pose[channel.name] = translation * rotation * scaling;
	});
