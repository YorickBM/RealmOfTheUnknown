...
public:
	...
	Inventory(Screen *screen, int width, int height, Vector2i position = Vector2i(15,15)) {
		...
		//Item stats
		_infoButtons["1"] = iconText(_infoContextBottomWindow, "Min. Level: N/A", ENTYPO_ICON_LAB_FLASK, "sand-bold", 16, { 255, 255, 255, 255 }, { 200, 20});
		_infoLines["1"] = line(_infoContextBottomWindow);
		_infoButtons["2"] =  iconText(_infoContextBottomWindow, "Req. Class: N/A", ENTYPO_ICON_NEWSLETTER, "sand-bold", 16, { 255, 255, 255, 255 }, { 200, 20 });
		_infoLines["2"] =  line(_infoContextBottomWindow);
		_infoButtons["3"] =  iconText(_infoContextBottomWindow, "Req. Quest: N/A", ENTYPO_ICON_CLIPBOARD, "sand-bold", 16, { 255, 255, 255, 255 }, {200, 20});
		...
		//Create Backpack
		_backpackBackgroundWindow = new Window(_screen, "");
		_backpacContextTopWindow = new Window(_screen, "");
		_backpacContextBottomWindow = new Window(_screen, "");
		...
		iconText(_backpacContextTopWindow, "INVENTORY", ENTYPO_ICON_SUITCASE, "sand-bold", 30, { 255, 255, 255, 255 }, {200, 38});
		emptySpace(_backpacContextTopWindow, 10, { 40, 40, 43, 255 });
		...
		createSlotRow(new Window(_screen, ""), _invRows);
		createSlotRow(new Window(_screen, ""), _invRows);
		createSlotRow(new Window(_screen, ""), _invRows);
		createSlotRow(new Window(_screen, ""), _invRows);
		createSlotRow(new Window(_screen, ""), _invRows);
		...
		//Create Toolbar
		_toolBarBackgroundWindow = new Window(_screen, "");
		_toolBarContextWindow = new Window(_screen, "");
	...
	void SetItem(int slot, Item item) {
		int imgLocation = LoadImage(item.image);
...
private:
	...
	Button* iconText(Window* window, string title, int ICON, string font = "sans-bold", int size = 16, Color color = Color(92, 92, 92, 255), Vector2i btnSize = {20, 10}) {
	...
	int LoadImage(string texturePath) {
